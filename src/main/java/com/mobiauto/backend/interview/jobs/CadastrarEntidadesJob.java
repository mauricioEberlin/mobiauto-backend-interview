...
public class CadastrarEntidadesJob {
    ...
    public void inserirRolesNoBanco() {
        ...
        roleService.save(Role.builder().id(2L).name(NivelAcessoConfig.NIVEL_GERENTE).build());
        roleService.save(Role.builder().id(3L).name(NivelAcessoConfig.NIVEL_PROPRIETARIO).build());
